...
//         hover:text-[#111111]
//         hover:-translate-y-1
//         hover:shadow-[0_20px_50px_rgba(250,204,21,0.25)]
//         active:scale-[0.96]
...
//                           <div className="text-[8px] uppercase tracking-wide opacity-80 leading-none">
//                             Download on the
//                           </div>
...
export default function HowItWorks() {
  ...
  return (
    <section className="bg-background py-16 md:py-24 px-4 sm:px-6 relative">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-12 lg:gap-24 relative items-start">
          ...
          {/* TOP / LEFT: Sticky Phone Mockup */}
          <div className="w-full md:w-1/2 sticky top-16 md:top-24 flex justify-center h-[400px] md:h-[600px] z-0">
            <div className="w-[300px] h-[600px] bg-black dark:bg-zinc-900 rounded-[3rem] p-3 shadow-2xl relative border border-zinc-800 dark:border-zinc-700 shrink-0 transform scale-[0.65] sm:scale-75 md:scale-100 origin-top transition-transform duration-700">

              {/* Phone Notch */}
              <div className="absolute top-0 inset-x-0 h-6 flex justify-center z-50">
                <div className="w-32 h-6 bg-black dark:bg-zinc-900 rounded-b-3xl"></div>
              </div>

              {/* Phone Screen Container - REMOVED the light border here */}
              <div className="w-full h-full bg-background rounded-[2.25rem] overflow-hidden relative font-sans flex flex-col">

                {/* App Header - Changed to bg-black to blend seamlessly with the phone notch */}
                <div className="bg-black dark:bg-zinc-950 text-white px-5 pt-10 pb-4 shrink-0 shadow-sm z-20">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[#EAB308] text-lg leading-none">✨</span>
                    <h3 className="font-bold text-[15px]">AI Architect Match</h3>
                  </div>
                ...
                {/* Dynamic Screen Content Wrapper */}
                <div className="relative flex-1 bg-background overflow-hidden p-5">

                  {/* --- SCREEN 1: Requirements --- */}
                  <div className={`absolute inset-0 p-5 transition-all duration-700 ease-in-out ${activeStep === 0 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10 pointer-events-none'}`}>
                    <div className="flex flex-col gap-4 mt-2">
                      <div className="bg-white dark:bg-zinc-800 p-3 rounded-2xl rounded-tl-none shadow-sm border border-zinc-100 dark:border-zinc-700 text-xs text-zinc-700 dark:text-zinc-300 font-medium max-w-[85%]">
                        Hello! I'm your Keywee AI. Where is your project located?
                      </div>
                      <div className="bg-zinc-900 dark:bg-zinc-700 text-white p-3 rounded-2xl rounded-tr-none shadow-sm text-xs font-medium self-end max-w-[85%]">
                        Gurugram, Haryana
                      </div>
                      <div className="bg-white dark:bg-zinc-800 p-3 rounded-2xl rounded-tl-none shadow-sm border border-zinc-100 dark:border-zinc-700 text-xs text-zinc-700 dark:text-zinc-300 font-medium max-w-[85%]">
                        Great. Select your project type:
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        <div className="bg-[#FFF9E6] dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700/50 text-[#D97706] dark:text-yellow-500 p-3 rounded-xl flex flex-col items-center justify-center gap-1 shadow-sm">
                          <span className="text-xl">🏠</span>
                          <span className="text-[10px] font-bold">Home</span>
                        </div>
                        <div className="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 p-3 rounded-xl flex flex-col items-center justify-center gap-1 shadow-sm">
                          <span className="text-xl">🏢</span>
                          <span className="text-[10px] font-bold">Commercial</span>
                        </div>
                      </div>
                  ...
                  <div className={`absolute inset-0 p-5 transition-all duration-700 ease-in-out ${activeStep === 1 ? 'opacity-100 translate-x-0' : activeStep < 1 ? 'opacity-0 translate-x-10 pointer-events-none' : 'opacity-0 -translate-x-10 pointer-events-none'}`}>
                    <div className="flex flex-col gap-4 mt-2">
                      ...
                      <div className="flex flex-wrap gap-2 self-end justify-end">
                        <span className="bg-zinc-900 dark:bg-zinc-700 text-white px-4 py-2 rounded-full text-[10px] font-bold">Kitchen</span>
                        <span className="bg-zinc-900 dark:bg-zinc-700 text-white px-4 py-2 rounded-full text-[10px] font-bold">Living Room</span>
                      </div>
                      <div className="bg-white dark:bg-zinc-800 p-3 rounded-2xl rounded-tl-none shadow-sm border border-zinc-100 dark:border-zinc-700 text-xs text-zinc-700 dark:text-zinc-300 font-medium max-w-[85%]">
                        Define your budget range:
                      </div>
                      <div className="bg-[#EAB308] dark:bg-yellow-600 text-white px-5 py-2.5 rounded-full text-[11px] font-bold self-end shadow-md">
                        10-25 Lakhs
                      </div>
                      <div className="mt-4 p-4 rounded-2xl border border-yellow-200 dark:border-yellow-700/50 bg-[#FFF9E6]/50 dark:bg-yellow-900/10 animate-pulse">
                        <p className="text-[10px] text-yellow-700 dark:text-yellow-500 font-bold text-center leading-relaxed">
                          Scanning 5,000+ verified architects in Gurugram for Smart Home within 10-25 lakhs...
                        </p>
                      </div>
                    </div>
                  ...
                  <div className={`absolute inset-0 p-5 transition-all duration-700 ease-in-out ${activeStep === 2 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10 pointer-events-none'}`}>
                    <div className="flex flex-col gap-4 h-full pt-4">
                      <div className="bg-[#EAB308] dark:bg-yellow-600 rounded-2xl p-1 shadow-lg relative overflow-hidden">
                        {/* Shimmer effect */}
                        <div className="absolute top-0 left-[-100%] w-1/2 h-full bg-gradient-to-r from-transparent via-white/30 dark:via-white/10 to-transparent skew-x-12 animate-[shimmer_2s_infinite]"></div>

                        <div className="bg-white dark:bg-zinc-900 rounded-[14px] p-4 relative z-10">
                          <div className="flex justify-between items-center mb-3 border-b border-zinc-100 dark:border-zinc-800 pb-3">
                            <span className="text-[9px] font-extrabold text-[#D97706] dark:text-yellow-500 tracking-widest uppercase">⭐ Top Match Found</span>
                            <span className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-2 py-0.5 rounded text-[8px] font-bold uppercase tracking-wider">Available</span>
                          </div>

                          <div className="flex gap-3 items-center mb-4">
                            <div className="w-12 h-12 rounded-full bg-zinc-200 dark:bg-zinc-800 border-2 border-[#FFF9E6] dark:border-yellow-900/20 overflow-hidden shrink-0">
                              <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=100&q=80" alt="Architect" className="w-full h-full object-cover" />
                            </div>
                            <div>
                              <h4 className="font-extrabold text-sm text-zinc-900 dark:text-zinc-100 leading-tight">Priya Sharma</h4>
                              <p className="text-[10px] text-zinc-500 dark:text-zinc-400 font-medium">Studio NS • Delhi</p>
                              <div className="text-[10px] text-zinc-900 dark:text-zinc-100 font-bold mt-0.5">⭐ 4.9 <span className="text-zinc-400 dark:text-zinc-500 font-normal">(124 reviews)</span></div>
                            </div>
                          </div>

                          <div className="flex gap-2">
                            <button className="flex-1 bg-black dark:bg-zinc-700 text-white text-[10px] font-bold py-2.5 rounded-lg">Connect | FREE</button>
                            <button className="flex-1 bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-[10px] font-bold py-2.5 rounded-lg border border-zinc-200 dark:border-zinc-700">View Profile</button>
                          </div>
                        </div>
                      </div>

                      <div className="mt-auto bg-zinc-900 dark:bg-zinc-800 text-white p-4 rounded-2xl flex items-center justify-between shadow-md border border-transparent dark:border-zinc-700">
                        <div className="flex -space-x-2">
                          <div className="w-6 h-6 rounded-full bg-zinc-500 border border-zinc-900 dark:border-zinc-800"></div>
                          <div className="w-6 h-6 rounded-full bg-zinc-400 border border-zinc-900 dark:border-zinc-800"></div>
                          <div className="w-6 h-6 rounded-full bg-zinc-300 border border-zinc-900 dark:border-zinc-800"></div>
                        </div>
                        <span className="text-[10px] font-medium">+12 other matches</span>
                      </div>
                    </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col relative z-10 pb-24 md:pb-0 -mt-10 md:mt-0">
            {STEPS.map((step, index) => (
              <div
                ...
                className={`min-h-[60dvh] md:min-h-[80dvh] flex flex-col justify-center transition-all duration-700 ${activeStep === index ? 'opacity-100 scale-100' : 'opacity-30 md:opacity-40 scale-95'}`}
              >
                <div className={`p-6 sm:p-10 rounded-3xl transition-all duration-500 ${activeStep === index ? 'bg-white/95 md:bg-white dark:bg-zinc-900/95 dark:md:bg-zinc-900 backdrop-blur-md shadow-xl shadow-zinc-200/40 dark:shadow-black/40 border border-zinc-100 dark:border-zinc-800' : 'bg-transparent'}`}>

                  {/* Step Badge */}
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#FFF9E6] dark:bg-yellow-900/30 text-[#D97706] dark:text-yellow-500 font-extrabold flex items-center justify-center text-base sm:text-lg mb-4 sm:mb-6 border border-yellow-100 dark:border-yellow-800/50 shadow-sm">
                    {step.id}
                  </div>

                  {/* Text Content */}
                  <h3 className="text-2xl sm:text-3xl font-extrabold text-foreground mb-3 sm:mb-4 tracking-tight">
                    {step.title}
                  </h3>
        ...
        group relative overflow-hidden
        flex items-center justify-center sm:justify-start gap-3
        bg-[#111111] dark:bg-zinc-800 border border-transparent dark:border-zinc-700
        rounded-2xl
        px-6 py-4
        text-[#F1F1F1]
        w-full sm:w-auto
        transition-all duration-300
        hover:text-white dark:hover:border-zinc-600
        hover:-translate-y-1
        hover:shadow-[0_20px_50px_rgba(250,204,21,0.25)]
        active:scale-[0.96]
        active:translate-y-0
