    ...
    <section className="relative overflow-hidden px-4 sm:px-6 py-10 md:py-16 text-center">
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mb-10 md:mb-14">
          ...
          <p className="mt-3 md:mt-4 text-zinc-500 text-sm sm:text-base md:text-xl font-medium max-w-xs sm:max-w-none mx-auto">
              ...
              <div className="relative flex items-center justify-between gap-3 md:gap-4">
                ...
                {city.active && (
                  <div className="relative flex items-center justify-center mr-1 md:mr-2">
                    ...
                    {/* Solid Dot */}
                    <span className="relative inline-flex h-2.5 w-2.5 md:h-3 md:w-3 rounded-full bg-[#DDA700]" />
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="mt-12 md:mt-16">
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 sm:gap-3 text-lg sm:text-xl md:text-3xl font-black tracking-tight leading-tight">
            ...
            <button className="group inline-flex items-center gap-1.5 md:gap-2 text-[#EAB308] underline underline-offset-4 hover:text-yellow-600 transition-all duration-300">
              Join the waitlist
