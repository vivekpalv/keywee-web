      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          >
            ...
            <svg className="relative z-10 transition-transform duration-300 group-hover:scale-110" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
