      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          >
            ...
            >
              <path
                d="M3.1 3.4C3.1 3.6 3 3.9 3 4.3V19.7C3 20 3.1 20.3 3.1 20.6L12.3 11.5L3.1 3.4Z"
                fill="#2196F3"
              />
              <path
                d="M16.5 15.6L12.3 11.5L3.1 20.6C3.5 20.9 4 21 4.7 20.6L16.5 15.6Z"
                fill="#F44336"
              />
              <path
                d="M16.5 8.4L4.7 3.4C4 3 3.5 3.1 3.1 3.4L12.3 11.5L16.5 8.4Z"
                fill="#4CAF50"
              />
              <path
                d="M21.1 12.8L16.5 15.6L12.3 11.5L16.5 8.4L21.1 11.2C21.8 11.6 21.8 12.4 21.1 12.8Z"
                fill="#FFEB3B"
              />
            </svg>
