    ...
    <div className="min-h-screen bg-background text-foreground font-sans py-12 px-6 transition-colors duration-300">
      <div className="mx-auto max-w-6xl relative">
        ...
        <div className="rounded-[2rem] border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 mb-12 shadow-sm relative overflow-hidden group">
          ...
          {/* EDIT PROFILE BUTTON */}
          <div className="absolute top-6 right-6">
            <button onClick={openEditProfile} className="text-xs font-bold border border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700 rounded-lg px-4 py-2 transition-colors shadow-sm">
              Edit Profile
            </button>
          </div>
            ...
            <div className="md:col-span-5 flex flex-col justify-center gap-4 text-sm font-semibold text-zinc-800 dark:text-zinc-200">
              <div className="grid grid-cols-2 gap-4 mb-2">
                <div className="bg-[#FFF9E6] dark:bg-yellow-900/20 border border-yellow-100 dark:border-yellow-700/30 p-4 rounded-2xl flex flex-col items-center justify-center text-center">
                  <span className="text-2xl font-black text-yellow-600 dark:text-yellow-500">{projects.length}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div key={proj._id} className="group rounded-[1.5rem] border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm flex flex-col overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <Link href={`/projects/${proj._id}`} className="block h-48 w-full bg-zinc-100 dark:bg-zinc-800 relative overflow-hidden cursor-pointer">
                      {proj.media && proj.media.length > 0 ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-zinc-50 dark:bg-zinc-800 text-zinc-300 dark:text-zinc-600 text-xs font-bold uppercase tracking-widest">
                          No Image Uploaded
                        </div>
                      )}
                      <div className="absolute top-3 right-3 bg-black/70 backdrop-blur-md text-white text-[10px] font-bold px-3 py-1.5 rounded-full capitalize">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex justify-between items-center bg-white dark:bg-zinc-900 p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
              ...
              <button onClick={() => setIsQualModalOpen(true)} className="text-xs font-bold border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 bg-white dark:bg-zinc-900 rounded-xl px-4 py-2.5 transition-colors">
                + Add
              </button>
            </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[2rem] w-full max-w-2xl p-8 max-h-[90vh] overflow-y-auto shadow-2xl border border-zinc-200 dark:border-zinc-800">
            ...
            <form onSubmit={handleSaveProfile} className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-3 gap-5">
                ...
                <div className="col-span-1">
                  {/* FIX: Added htmlFor="experience" */}
                  <label htmlFor="experience" className="text-xs font-bold text-zinc-900 dark:text-zinc-300 uppercase tracking-wide mb-2 block">
                    Experience (Yrs)
                  </label>

                  {/* FIX: Added id="experience" to match the label, and added a placeholder */}
                  <input
                    id="experience"
                    required
                    type="number"
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-zinc-900/60 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-zinc-900 rounded-[2rem] w-full max-w-2xl p-8 max-h-[90vh] overflow-y-auto shadow-2xl border border-zinc-200 dark:border-zinc-800">
            ...
            <form onSubmit={handleSaveProject} className="flex flex-col gap-5">
              ...
              <div>
                <label className="text-xs font-bold text-zinc-900 dark:text-zinc-300 uppercase tracking-wide mb-2 block">Project Title</label>
